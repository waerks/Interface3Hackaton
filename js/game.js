...
function preload() {
  ...
  // Sons
  this.load.audio("backgroundMusic", "./assets/Sound/Spring Break.wav");
  ...
  this.load.audio("nextButtonSound", "./assets/Sound/nextButton.wav");
  this.load.audio("restartButtonSound", "./assets/Sound/restartButton.wav");
